...
namespace TownOfUs
{
    ...
    public class ModUpdaterButton
    {
        ...
        {
            var text = ModUpdater.Httpclient.GetAsync("https://github.com/badzyn/Town-Of-Us-R/raw/master/source/Versioning.json")
    ...
    public class ModUpdater
    {
        ...
        public static async Task<bool> checkForUpdate(string updateType = "TOU")
        {
            ...
            try
            {
                ...
                if (updateType == "TOU")
                {
                    githubURI = "https://api.github.com/repos/badzyn/Town-Of-Us-Unofficial/releases/latest";
                }
                else if (updateType == "Submerged")
                {
