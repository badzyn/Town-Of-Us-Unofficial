...
namespace TownOfUs.NeutralRoles.GhoulMod
{
    public class Coroutine
    {
        ...
        public static IEnumerator EatCoroutine(DeadBody body, Ghoul role)
        {
            if (PlayerControl.LocalPlayer.Is(RoleEnum.Lookout))
            {
                ...
                {
                    if (!lookout.Watching[body.ParentId].Contains(RoleEnum.Ghoul)) lookout.Watching[body.ParentId].Add(RoleEnum.Ghoul);
                }
            }
